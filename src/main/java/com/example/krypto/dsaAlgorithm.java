...
public class dsaAlgorithm {
    ...
    public static BigInteger p, q, h, r, a, b, r1, s1, s2, pm1, sp, u1, u2, t;
    static int l;
    ...
    public static void signatureText(String text) {
        generatR();
        calcR1();
        calcS1();
        calcS2(text);
    ...
    public static void checkSignatureText(String text) {
        System.out.println(s1.intValue());
        System.out.println(s2.intValue());
        calcSp();
        calcU1(text);
